...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/gestion-comercial-top.png) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Gestión Comercial</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>El objetivo general de la carrera de Gestión Comercial es dotar de conocimientos y desarrollar habilidades
                                       en los estudiantes para que puedan resolver creativamente problemas y tomar decisiones en el ámbito
                                       comercial orientados en el desarrollo sostenible de las organizaciones. El profesional será capaz de
                                       gestionar, modelar y desarrollar soluciones integrales a problemas vinculados a su disciplina a través de
                                       sólidos fundamentos teóricos y prácticos que conlleve a visualizar nuevos enfoques para expandir el
                                       desarrollo de las ciencias.</p>
                                 </div>
                              </div>
                           </div>
                           <div class="gdlr-core-pbf-element">
                                    ...
                                    <ul>
                                       <li class=" gdlr-core-skin-divider clearfix">
                                          <div class="gdlr-core-icon-list-content-wrap">
                                             <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Gerente de Ventas</span>
                                          </div>
                                       </li>
                                       <li class=" gdlr-core-skin-divider clearfix">
                                          <div class="gdlr-core-icon-list-content-wrap">
                                             <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Ejecutivo de Cuentas</span>
                                          </div>
                                       </li>
                                       <li class=" gdlr-core-skin-divider clearfix">
                                          <div class="gdlr-core-icon-list-content-wrap">
                                             <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Analista de Marketing</span>
                                          </div>
                                       </li>
                                       <li class=" gdlr-core-skin-divider clearfix">
                                          <div class="gdlr-core-icon-list-content-wrap">
                                             <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Coordinador de Trade Marketing</span>
                                          </div>
                                       </li>
                                       <li class=" gdlr-core-skin-divider clearfix">
                                          <div class="gdlr-core-icon-list-content-wrap">
                                             <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Especialista en Desarrollo de Negocios</span>
                                          </div>
                                       </li>
                                       <li class=" gdlr-core-skin-divider clearfix">
                                          <div class="gdlr-core-icon-list-content-wrap">
                                             <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Analista Comercial</span>
                                          </div>
                                       </li>
                                       <li class=" gdlr-core-skin-divider clearfix">
                                          <div class="gdlr-core-icon-list-content-wrap">
                                             <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Consultor Comercial</span>
                                          </div>
                                       </li>
                                    </ul>
                                 </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Licenciado/a en Gestión Comercial</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-32-No.498-2022</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <iframe src="https://webservices.uees.edu.ec/formularios/formulario-web-grado.php?carrera=Gestión Comercial&utm_source=&utm_campaign=" style="height:900px;width:100%;border:none;" title="Formulario Web" id="form-params-dinamic"></iframe>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/gestion-comercial-01.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                                 ...
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Demuestra habilidades sólidas en gestión comercial, incluyendo planificación estratégica, análisis de
                                                   mercado, gestión de ventas y estrategias de marketing eficientes.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Posee comunicación asertiva y negociación, interactuando efectivamente con clientes y proveedores,
                                                   enfocándose en la satisfacción y fidelización del cliente.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Desarrolla pensamiento estratégico y analítico para comprender el entorno empresarial, identificar
                                                   oportunidades de mercado y crear planes de acción efectivos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Utiliza herramientas tecnológicas y sistemas de información para gestionar procesos comerciales y
                                                   tomar decisiones basadas en datos de forma óptima.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Adapta y gestiona el cambio con inteligencia relacional, estableciendo relaciones colaborativas y
                                                   liderando equipos con integridad y enfoque en el beneficio mutuo.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Demuestra compromiso con la ética y responsabilidad social, promoviendo prácticas comerciales
                                                   sostenibles y contribuyendo al desarrollo de organizaciones y la sociedad.</span>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                 ...
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Los graduados de esta carrera se destacan por su capacidad para gestionar estrategias comerciales
                                                   efectivas, liderando equipos multidisciplinarios y garantizando la alineación de las tácticas de ventas con
                                                   los objetivos organizacionales. Poseen habilidades de comunicación y negociación que les permiten
                                                   interactuar con clientes, proveedores y otros actores clave, facilitando la creación de alianzas estratégicas
                                                   y la resolución de problemas en diversos contextos comerciales.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Además, están comprometidos con la innovación y la mejora continua, siempre en búsqueda de nuevas
                                                   oportunidades de negocio y soluciones para optimizar los procesos comerciales. Están preparados para
                                                   utilizar herramientas y técnicas cuantitativas avanzadas, evaluando riesgos y beneficios dentro de un
                                                   contexto dinámico y cambiante.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">La Licenciatura en Gestión Comercial prepara a los graduados para desempeñarse con éxito en roles
                                                   estratégicos y operativos dentro de las organizaciones. Contribuyen al diseño, implementación y gestión
                                                   de estrategias comerciales que agregan valor y potencian el crecimiento sostenible de las empresas.
                                                   Además, demuestran una sólida capacidad de liderazgo y trabajo en equipo, adaptándose a nuevas
                                                   situaciones y gestionando iniciativas empresariales con una visión global y ética.</span>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/gestion-comercial-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                     ...
                     <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 15px ;">
                           ...
                           <p>Esta carrera aplica para :</p>
                           <li><a href="https://online.uees.edu.ec/homologacion-de-estudios" target="_blank">Homologación de estudios</a></li>
                           <li><a href="https://online.uees.edu.ec/validacion-de-ejercicio-profesionales" target="_blank">Validación de ejercicios profesional</a></li>
                        </div>
                     </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-20 gdlr-core-column-first">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 10px ;"><a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-left-align gdlr-core-button-no-border" href="https://online.uees.edu.ec/grado/mallas/GESTIO%CC%81N%20COMERCIAL.pdf" target="_blank" style="padding: 10px 30px 10px 30px;border-radius: 3px;-moz-border-radius: 3px;-webkit-border-radius: 3px;"><span class="gdlr-core-content">Malla Curricular</span><i class="gdlr-core-pos-right fa fa-file-pdf-o"></i></a></div>
                              </div>
                           </div>
                        </div>
                     </div>
