...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
   ...
   <div class="kingster-body-outer-wrapper ">
      <div class="kingster-body-wrapper clearfix  kingster-with-frame">
         ...
         <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(../images/carreras/gestion-ambiental-top.jpg) ;">
            ...
            <div class="kingster-page-title-container kingster-container">
               <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 200px ;padding-bottom: 80px ;">
                  ...
                  <h1 class="kingster-page-title" style="text-transform: none ;">Gestión Ambiental</h1>
               </div>
            </div>
         </div>
                           ...
                           <div class="gdlr-core-pbf-element">
                              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                 <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>Formar profesionales capaces de comprender y abordar los desafíos
                                       ambientales y la gestión sostenible de recursos naturales, capaces de evaluar
                                       y mitigar impactos ambientales en diversos contextos, como la industria, la
                                       agricultura, el gobierno y la comunidad y que tomen decisiones informadas y
                                       responsables en relación con el medio ambiente y los recursos naturales,
                                       aportando al desarrollo de estrategias y políticas ambientales que fomenten la
                                       conservación y el uso sostenible de los recursos naturales.</p>
                                 </div>
                              </div>
                           </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">Licenciado en Gestión Ambiental</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 30px;">
                                             ...
                                             <div class="gdlr-core-column-service-content-wrapper">
                                                <div class="gdlr-core-column-service-title-wrap">
                                                   ...
                                                   <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 15px ;font-weight: 500 ;font-style: normal ;">RPC-SO-27-No.450-2023</div>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div class="textwidget" style="box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -moz-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); -webkit-box-shadow: 0 -6px 24px rgba(10, 10, 10,0.09); background-color: #ffffff ;border-radius:  3px 3px ;-moz-border-radius:  3px 3px ;-webkit-border-radius:  3px 3px ;">
                                 <div class="gdlr-core-widget-box-shortcode " style="color: #821436 ;padding: 25px 5px;background-color: #ffffff ;">
                                    <div class="gdlr-core-widget-box-shortcode-content">
                                       ...
                                       <div class="gdlr-core-pbf-element">
                                          <iframe src="https://webservices.uees.edu.ec/formularios/formulario-web-grado.php?carrera=Gestión Ambiental&utm_source=&utm_campaign=" style="height:900px;width:100%;border:none;" title="Formulario Web" id="form-params-dinamic"></iframe>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-8638">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-left" data-sync-height="height-2" style="height: 860.461px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/gestion-ambiental-01.jpg); background-size: cover; background-position: center center; height: 875.969px; transform: translate(0px, -43.5328px);" data-parallax-speed="0.2"></div>
                           </div>
                                 ...
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <ul>
                                          ...
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Trabajo en equipo interdisciplinario.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                          ...
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Ética y Responsabilidad ambiental.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Gestión de Recursos Naturales.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Evaluación del Impacto Ambiental.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                 ...
                                 <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 17px ;text-transform: none ;">
                                       <ul>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Ejercer un juicio informado y basado en evidencia al establecer conclusiones relevantes a partir de los datos obtenidos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Fomentar iniciativas de innovación y emprendimiento en el ámbito empresarial, promoviendo ideas y proyectos que generen valor y contribuyan al desarrollo económico y social.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Identificar y definir problemas complejos dentro del contexto de la problemática socioambiental, demostrando habilidades para analizar y comprender la interrelación entre aspectos sociales y ambientales.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Realizar diagnósticos de problemas ambientales y propone soluciones que satisfacen las necesidades considerando factores sociales, ambientales y económicos.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Participar en el diseño y gestión de proyectos orientados a la solución de problemas ambientales, alineados con los Objetivos de Desarrollo Sostenible (ODS).</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Realizar estimaciones de riesgo ambiental y gestiona los riesgos identificados.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Evaluar la probabilidad y magnitud de los impactos ambientales negativos y desarrollar estrategias para minimizar y gestionar los riesgos ambientales.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Contribuir en el diseño e implementación de procesos de regulación, seguimiento y control de calidad ambiental, cumpliendo con los estándares nacionales e internacionales establecidos en las normativas vigentes.</span>
                                             </div>
                                          </li>
                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Brindar asesoramiento en la gestión ambiental a direcciones o departamentos ambientales de instituciones públicas y privadas, en relación con la gestión del territorio, la contaminación ambiental y la utilización de los recursos naturales.</span>
                                             </div>
                                          </li>

                                          <li class=" gdlr-core-skin-divider clearfix">
                                             <div class="gdlr-core-icon-list-content-wrap">
                                                <span class="gdlr-core-icon-list-content" style="font-size: 16px;text-align: justify;">Proponer acciones que coadyuven al cumplimiento de los Objetivos de Desarrollo Sostenible (ODS), Contribuir a fortalecer las capacidades en las comunidades de personas hacia el manejo y gestión ambiental para conservar el patrimonio natural y saberes ancestrales, incentivando prácticas que permitan aumentar la resiliencia y la adaptación frente a los riesgos y desastres.</span>
                                             </div>
                                          </li>
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-36639">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js  gdlr-core-column-extend-right" data-sync-height="height-1" style="height: 653.976px;">
                           <div class="gdlr-core-pbf-background-wrap">
                              <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(../images/carreras/gestion-ambiental-02.jpg); background-size: cover; background-position: center center; height: 710.762px; transform: translate(0px, -35.625px);" data-parallax-speed="0.2"></div>
                           </div>
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                     </div>
                  ...
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                     ...
                     <div class="gdlr-core-pbf-column gdlr-core-column-20 gdlr-core-column-first">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 10px ;"><a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-left-align gdlr-core-button-no-border" href="https://online.uees.edu.ec/grado/mallas/GESTIO%CC%81N%20AMBIENTAL.pdf" target="_blank" style="padding: 10px 30px 10px 30px;border-radius: 3px;-moz-border-radius: 3px;-webkit-border-radius: 3px;"><span class="gdlr-core-content">Malla Curricular</span><i class="gdlr-core-pos-right fa fa-file-pdf-o"></i></a></div>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                  <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                     <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 40px ;">
                           <div class="gdlr-core-title-item-title-wrap clearfix">
                              <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 30px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #161616 ;margin-right: 30px ;">Podcast Ambiental Comunica</h3>
                              <div class="gdlr-core-title-item-divider gdlr-core-right gdlr-core-skin-divider" style="font-size: 22px ;border-bottom-width: 3px ;"></div>
                           </div>
                        </div>
                     </div>
                     <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" style="float: left;">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                              <div class="gdlr-core-pbf-element" style="padding-left:20px">
                                 <iframe style="border-radius:12px" src="https://open.spotify.com/embed/show/5dQqWPFDwP6WiofSTWfzYJ?utm_source=generator" width="100%" height="200" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="gdlr-core-pbf-column gdlr-core-column-30" style="padding: 30px 30px 60px;">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                           <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                              <div class="gdlr-core-pbf-element">
                                 <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 30px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">Huellas que Transforman:<br> El Impacto de la ingeniería Ambiental y la Biodiversidad</h3>
                                 </div>
                              </div>
                           </div>
                        </div>
   ...
   <script>
      document.addEventListener('DOMContentLoaded', function() {
         Swal.fire({
            html: `
            <a href="https://open.spotify.com/episode/2veLkNCbudIQRQqpLiQXCh?go=1&sp_cid=12f62c98fd1297ae938573e026603aad&t=885&utm_source=embed_player_p&utm_medium=desktop" target="_blank">
                <img src="https://online.uees.edu.ec/upload/arte-ambiental-podcast.jpg" alt="Podcast" style="width: 100%; cursor: pointer;">
            </a>
        `,
            showConfirmButton: true,
            confirmButtonText: 'Ir al podcast',
            buttonsStyling: false, // Desactivar estilos por defecto
            customClass: {
               confirmButton: 'custom-swal-button',
               closeButton: 'custom-swal-close' // Clase para el botón de cerrar
            },
            showCloseButton: true, // Mostrar botón de cerrar
            width: '600px', // Ajustar el ancho del modal
         }).then((result) => {
            // Si se hace clic en el botón "Ir al podcast"
            if (result.isConfirmed) {
               window.open('https://open.spotify.com/episode/2veLkNCbudIQRQqpLiQXCh?go=1&sp_cid=12f62c98fd1297ae938573e026603aad&t=885&utm_source=embed_player_p&utm_medium=desktop', '_blank');
            }
         });
      });
   </script>
   ...
   <style>
      .custom-swal-button {
         ...
         color: #ffffff;
         /* Color blanco para el texto, legible */
         padding: 10px 20px;
         border-radius: 5px;
         border: none;
         font-size: 16px;
